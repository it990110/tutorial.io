...
export const ThemeConfigSchema = Joi.object<ThemeConfig>({
  ...
  footer: Joi.object({
    ...
    links: Joi.alternatives(
      ...
      .messages({
        'alternatives.match': `The footer must be either simple or multi-column, and not a mix of the two. See: https://tutorial.io/docs/api/themes/configuration#footer-links`,
      })
      .default([]),
  }).optional(),
  prism: Joi.object({
  ...
  sidebarCollapsible: Joi.forbidden().messages({
    'any.unknown':
      'The themeConfig.sidebarCollapsible has been moved to docs plugin options. See: https://tutorial.io/docs/api/plugins/@docusaurus/plugin-content-docs',
  }),
