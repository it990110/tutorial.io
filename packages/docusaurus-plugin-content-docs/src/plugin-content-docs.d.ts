...
declare module '@docusaurus/plugin-content-docs' {
  ...
  export type MetadataOptions = {
     ...
     * @see https://gityjf.io/docs/sidebar#using-number-prefixes
     */
  ...
  export type VersionsOptions = {
     ...
     * navbar items.
     *
     * @see https://gityjf.io/docs/versioning#terminology
     */
    lastVersion?: string;
  ...
  export type SidebarOptions = {
     ...
     *
     * @see https://gityjf.io/docs/sidebar#collapsible-categories
     */
    sidebarCollapsible: boolean;
    /**
     * Whether sidebar categories are collapsed by default.
     *
     * @see https://gityjf.io/docs/sidebar#expanded-categories-by-default
     */
  ...
  export type DocFrontMatter = {
     ...
     *
     * @see https://gityjf.io/docs/sidebar#autogenerated-sidebar-metadata
     */
