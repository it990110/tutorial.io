...
declare module '@docusaurus/plugin-content-docs' {
  ...
  export type MetadataOptions = {
     ...
     * @see https://docusaurus/docs/sidebar#using-number-prefixes
     */
  ...
  export type VersionsOptions = {
     ...
     * navbar items.
     *
     * @see https://docusaurus/docs/versioning#terminology
     */
    lastVersion?: string;
  ...
  export type SidebarOptions = {
     ...
     *
     * @see https://docusaurus/docs/sidebar#collapsible-categories
     */
    sidebarCollapsible: boolean;
    /**
     * Whether sidebar categories are collapsed by default.
     *
     * @see https://docusaurus/docs/sidebar#expanded-categories-by-default
     */
  ...
  export type DocFrontMatter = {
     ...
     *
     * @see https://docusaurus/docs/sidebar#autogenerated-sidebar-metadata
     */
