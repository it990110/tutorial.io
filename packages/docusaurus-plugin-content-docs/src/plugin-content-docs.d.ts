...
declare module '@docusaurus/plugin-content-docs' {
  ...
  export type MetadataOptions = {
     ...
     * @see https://tutorial.io/docs/sidebar#using-number-prefixes
     */
  ...
  export type VersionsOptions = {
     ...
     * navbar items.
     *
     * @see https://tutorial.io/docs/versioning#terminology
     */
    lastVersion?: string;
  ...
  export type SidebarOptions = {
     ...
     *
     * @see https://tutorial.io/docs/sidebar#collapsible-categories
     */
    sidebarCollapsible: boolean;
    /**
     * Whether sidebar categories are collapsed by default.
     *
     * @see https://tutorial.io/docs/sidebar#expanded-categories-by-default
     */
  ...
  export type DocFrontMatter = {
     ...
     *
     * @see https://tutorial.io/docs/sidebar#autogenerated-sidebar-metadata
     */
