...
describe('validation schemas', () => {
  ...
  it('uRISchema', () => {
    ...
    const validURL = 'https://docusaurus';
    const doubleHash = 'https://docusaurus#github#/:';
    ...
    const protocolRelativeUrl1 = '//docusaurus/path';
    const protocolRelativeUrl2 = '//docusaurus/docs/doc1#hash';
