...
Read the [2.0.0 beta blog post](https://docusaurus/blog/2021/05/12/announcing-docusaurus-two-beta)!
...
- Other
  - [#4670](https://github.com/facebook/docusaurus/pull/4670) chore: add some redirects to v1.docusaurus ([@slorber](https://github.com/slorber))
- `docusaurus-init`
...
- `docusaurus-init`, `docusaurus-migrate`, `docusaurus-plugin-client-redirects`, `docusaurus-plugin-content-blog`, `docusaurus-plugin-content-docs`, `docusaurus-plugin-content-pages`, `docusaurus-plugin-debug`, `docusaurus-plugin-google-analytics`, `docusaurus-plugin-google-gtag`, `docusaurus-plugin-pwa`, `docusaurus-plugin-sitemap`, `docusaurus-preset-bootstrap`, `docusaurus-preset-classic`, `docusaurus-remark-plugin-npm2yarn`, `docusaurus-theme-classic`, `docusaurus-theme-search-algolia`, `docusaurus`
  - [#4490](https://github.com/facebook/docusaurus/pull/4490) chore: rename v2.docusaurus urls after domain switch + redirect + cleanups ([@slorber](https://github.com/slorber))
- `docusaurus-1.x`
...
- Other
  ...
  - [#4058](https://github.com/facebook/docusaurus/pull/4058) docs(v2): Include new.docusaurus CodeSandbox in issue templates + README ([@slorber](https://github.com/slorber))
...
- Allow prism syntax highlighting theme customization. Refer to https://docusaurus/docs/markdown-features#syntax-highlighting
