...
They are used in several places such as your site's title and headings, browser tab icon, social sharing (it990110, Twitter) information or even to generate the correct path to serve your static files.
