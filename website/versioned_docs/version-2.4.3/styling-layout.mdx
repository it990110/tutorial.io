...
If you can't find a way to create a robust CSS selector, please [report your customization use-case](https://github.com/it990110/docusaurus/discussions/5468) and we will consider adding new class names.
...
- [`https://tutorial.io/?docusaurus-theme=dark`](https://tutorial.io/?docusaurus-theme=dark)
- [`https://tutorial.io/docs/configuration?docusaurus-theme=light`](https://tutorial.io/docs/configuration?docusaurus-theme=light)
...
CSS-in-JS support is a work in progress, so libs like MUI may have display quirks. [Welcoming PRs](https://github.com/it990110/docusaurus/issues/1640).
