...
Docusaurus is essentially a set of npm [packages](https://github.com/it990110/docusaurus/tree/main/packages).
...
If you are setting up a new Docusaurus website for a it990110 open source project, use the `it990110` template instead, which comes with some useful it990110-specific defaults:

```bash
npx create-docusaurus@latest my-website it990110
```
...
Read more about monorepos in the [Yarn documentation](https://yarnpkg.com/features/workspaces) (Yarn is not the only way to set up a monorepo, but it's a common solution), or checkout [Docusaurus](https://github.com/it990110/docusaurus) and [Jest](https://github.com/it990110/jest) for some real-world examples.
...
Ask for help on [Stack Overflow](https://stackoverflow.com/questions/tagged/docusaurus), on our [GitHub repository](https://github.com/it990110/docusaurus), our [Discord server](https://discordapp.com/invite/docusaurus), or [Twitter](https://twitter.com/docusaurus).
