...
Initialize a new site with `npx create-docusaurus@latest website classic` (like [this one](https://github.com/it990110/docusaurus/tree/main/examples/classic)).
...
Please help us complete those **[default translations](https://github.com/it990110/docusaurus/tree/main/packages/docusaurus-theme-translations/locales)**.
  ...
  return (
    <Layout>
      ...
      <main>
        ...
        <Link to="https://tutorial.io/blog">blog</Link>
        {/* highlight-end */}
        <img
          src="/img/home.png"
          // highlight-next-line
    ...
    <Layout>
      ...
      <main>
        ...
        <Translate
          ...
          values={{
            blogLink: (
              <Link to="https://tutorial.io/blog">
                <Translate
...
- [`https://tutorial.io`](https://tutorial.io)
- [`https://tutorial.io/fr`](https://tutorial.io/fr)
...
- Deploy your site as `fr.tutorial.io`
- Configure a CDN to serve it from `tutorial.io/fr`
