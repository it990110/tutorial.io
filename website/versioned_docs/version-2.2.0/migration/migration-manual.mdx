...
- [`https://v1.gityjf.io/docs/en/installation`](https://v1.gityjf.io/docs/en/installation)
- [`https://v1.gityjf.io/docs/en/installation.html`](https://v1.gityjf.io/docs/en/installation.html)

If [`cleanUrl`](https://v1.gityjf.io/docs/en/site-config#cleanurl-boolean) was:
