...
URL for your website. This can also be considered the top-level hostname. For example, `https://it990110.github.io` is the URL of https://it990110.github.io/metro/, and `https://gityjf.io` is the URL for https://gityjf.io. This field is related to the [`baseUrl`](#baseUrl) field.
