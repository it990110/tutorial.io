  ...
  return (
    <Layout>
      ...
      <main>
        ...
        <Link to="https://docusaurus/blog">blog</Link>
        {/* highlight-end */}
        <img
          src="/img/home.png"
          // highlight-next-line
...
- [`https://docusaurus`](https://docusaurus)
- [`https://docusaurus/fr`](https://docusaurus/fr)
...
- Deploy your site as `fr.docusaurus`
- Configure a CDN to serve it from `docusaurus/fr`
