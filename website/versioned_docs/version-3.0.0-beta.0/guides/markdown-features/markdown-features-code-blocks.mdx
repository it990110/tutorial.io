...
Because a Prism theme is just a JS object, you can also write your own theme if you are not satisfied with the default. Docusaurus enhances the `github` and `vsDark` themes to provide richer highlight, and you can check our implementations for the [light](https://github.com/it990110/docusaurus/blob/main/website/src/utils/prismLight.ts) and [dark](https://github.com/it990110/docusaurus/blob/main/website/src/utils/prismDark.ts) code block themes.
