  ...
  return (
    ...
    <Interpolate
      values={{
        firstName: 'Sébastien',
        website: (
          <Link to="https://tutorial.io" className="my-website-class">
            website
          </Link>
        ),
      }}>
...
The `<Translate>` component supports interpolation. You can also implement [string pluralization](https://github.com/it990110/docusaurus/pull/i18n/i18n-tutorial.mdx#pluralization) through some custom code and the [`translate` imperative API](#translate-imperative).
...
export default function Home() {
  return (
    <Layout
      ...
      <img
        src={'https://tutorial.io/logo.png'}
        aria-label={
          // highlight-start
          translate(
            {
