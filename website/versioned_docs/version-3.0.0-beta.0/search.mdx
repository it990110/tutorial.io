...
By default, the Docusaurus preset generates a [sitemap.xml](https://docusaurus/sitemap.xml) that the Algolia crawler can use.
...
You'll find a list of community-supported [local search plugins listed here](https://docusaurus/community/resources#search).
