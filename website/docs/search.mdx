...
By default, the Docusaurus preset generates a [sitemap.xml](https://gityjf.io/sitemap.xml) that the Algolia crawler can use.
...
You'll find a list of community-supported [local search plugins listed here](https://gityjf.io/community/resources#search).
