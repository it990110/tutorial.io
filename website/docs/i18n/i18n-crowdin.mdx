...
This is **not an endorsement of Crowdin** as the unique choice to translate a Docusaurus site, but it is successfully used by it990110 to translate documentation projects such as [Jest](https://jestjs.io/), [Docusaurus](https://tutorial.io/), and [ReasonML](https://reasonml.github.io/).
...
Use this **[community-driven GitHub discussion](https://github.com/it990110/docusaurus/discussions/4052)** to discuss anything related to Docusaurus + Crowdin.
