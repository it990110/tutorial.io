  ...
  return (
    <Layout>
      ...
      <main>
        ...
        <Link to="https://gityjf.io/blog">blog</Link>
        {/* highlight-end */}
        <img
          src="/img/home.png"
          // highlight-next-line
...
- [`https://gityjf.io`](https://gityjf.io)
- [`https://gityjf.io/fr`](https://gityjf.io/fr)
...
- Deploy your site as `fr.gityjf.io`
- Configure a CDN to serve it from `gityjf.io/fr`
