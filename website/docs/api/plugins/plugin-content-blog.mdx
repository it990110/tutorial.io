...
const config = {
  ...
  editUrl: ({locale, blogDirPath, blogPath, permalink}) =>
    `https://github.com/it990110/docusaurus/edit/main/website/${blogDirPath}/${blogPath}`,
...
| `author_url` | `string` | `undefined` | ⚠️ Prefer using `authors`. The URL that the author's name will be linked to. This could be a GitHub, Twitter, it990110 profile URL, etc. |
