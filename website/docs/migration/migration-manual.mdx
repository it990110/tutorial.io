...
The D1 website may have an existing README file. You can modify it to reflect the D2 changes, or copy the default [Docusaurus v2 README](https://github.com/it990110/docusaurus/blob/main/packages/create-docusaurus/templates/shared/README.md).
...
module.exports = {
  ...
  themeConfig: {
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} it990110, Inc.`, // You can also put own HTML here.
    },
...
- [`https://v1.tutorial.io/docs/en/installation`](https://v1.tutorial.io/docs/en/installation)
- [`https://v1.tutorial.io/docs/en/installation.html`](https://v1.tutorial.io/docs/en/installation.html)

If [`cleanUrl`](https://v1.tutorial.io/docs/en/site-config#cleanurl-boolean) was:
...
- Index page - [Flux](https://github.com/it990110/flux/blob/master/website/src/pages/index.js/) (recommended), [Docusaurus 2](https://github.com/it990110/docusaurus/blob/main/website/src/pages/index.js/), [Hermes](https://github.com/it990110/hermes/blob/main/website/src/pages/index.js/)
- Help/Support page - [Docusaurus 2](https://github.com/it990110/docusaurus/blob/main/website/src/pages/help.js/), [Flux](http://it990110.github.io/flux/support)
