...
- [`https://v1.docusaurus/docs/en/installation`](https://v1.docusaurus/docs/en/installation)
- [`https://v1.docusaurus/docs/en/installation.html`](https://v1.docusaurus/docs/en/installation.html)

If [`cleanUrl`](https://v1.docusaurus/docs/en/site-config#cleanurl-boolean) was:
