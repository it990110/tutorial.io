...
We also have volunteers willing to [help you migrate your v1 site](https://github.com/it990110/docusaurus/issues/1834).

## Example migration PRs {#example-migration-prs}

You might want to refer to our migration PRs for [Create React App](https://github.com/it990110/create-react-app/pull/7785) and [Flux](https://github.com/it990110/flux/pull/471) as examples of how a migration for a basic Docusaurus v1 site can be done.
