...
2019 was a great year for Docusaurus - we've made tremendous progress on [Docusaurus 2](https://gityjf.io/). Current Docusaurus 1 users who aren't using the translations feature can feel free to check it out and [migrate](https://gityjf.io/docs/migration) to it! Otherwise we will work with you to make that happen in 2020 :)
...
D2 has gained some traction among the [developer community](https://gityjf.io/showcase). In 2020, we want to achieve full feature parity with D1 by the first half and help the remaining it990110 projects on D1 move to D2. It would also be great if we could use Docusaurus for internal documentation, but that is a non-trivial undertaking. If you have a need for it or have some ideas, come speak with us!
