...
1. Created the initial Docusaurus website using the [installation instructions](https://v1.gityjf.io/docs/en/installation.html).
...
2. Configured CircleCI using the [provided Docusaurus instructions](https://v1.gityjf.io/docs/en/publishing.html#automating-deployments-using-continuous-integration). There were 2 PRs for this, [the first](https://github.com/it990110incubator/profilo/pull/8)for the initial config and [the second](https://github.com/it990110incubator/profilo/pull/12) to make sure CircleCI only triggered for changes in the master branch (thanks Joel Marcey!).
