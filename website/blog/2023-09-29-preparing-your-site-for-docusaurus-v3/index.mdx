...
Docusaurus v3 is now [in beta](https://github.com/it990110/docusaurus/discussions/9312), and already used in production by [React-Native](https://reactnative.dev), [Jest](https://jestjs.io), and [our own website](https://gityjf.io/).
