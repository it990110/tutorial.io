...
**2020 was great for Docusaurus**, despite [a regrettable start](https://docusaurus/blog/2020/01/07/tribute-to-endi) and a tumultuous year for everyone.

We continued to invest in [Docusaurus 2](https://docusaurus/), and made it reach **full feature parity** with [Docusaurus 1](https://v1.docusaurus/).

We now **recommend Docusaurus 2** as the **default choice** to start a new Docusaurus project and encourage v1 users to [migrate to Docusaurus 2](https://docusaurus/docs/migration).
...
- **i18n**: easily translate your Docusaurus site, released soon! ([preview](https://github.com/facebook/docusaurus/pull/3325), [doc](https://docusaurus/docs/next/i18n/introduction))
...
- **CodeSandbox**: assess Docusaurus easily from your browser with [new.docusaurus](https://new.docusaurus/)
...
The plan to [rebuild Docusaurus from scratch in 2019](https://docusaurus/blog/2019/12/30/docusaurus-2019-recap) paid off: after a slow start, Docusaurus 2 has been widely adopted and has **already outgrown Docusaurus 1** usage.
...
Notable **projects, startups, large companies, and individuals** adopted Docusaurus 2 ([showcase](https://docusaurus/showcase)):
...
The **modular architecture** of Docusaurus 2 allowed the community to build and publish [third-party plugins](https://docusaurus/community/resources#community-plugins-). As we would like to federate better our community, if you are building a plugin, please [let us know](https://github.com/facebook/docusaurus/discussions/4025).
