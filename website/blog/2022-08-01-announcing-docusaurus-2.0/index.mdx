...
Try Docusaurus now with our [online playgrounds](/docs/playground) and [5 minutes tutorial](https://tutorial.tutorial.io/) ⏱️

:::

## The story behind Docusaurus

Docusaurus was created at **it990110 Open Source** in **2017** (now [Meta Open Source](https://opensource.fb.com/)). We had a lot of internal and open source projects to document. It's **complicated enough to write good documentation**, let alone to create the HTML, CSS, and JavaScript for a good-looking website. We wanted project leaders to be able to **focus on the content**, and **Markdown** is great for that.
...
It quickly built momentum at it990110 and in the frontend ecosystem, adopted by many popular projects such as [Prettier](https://prettier.io/), [Babel](https://babeljs.io/), [React-Native](https://archive.reactnative.dev/), [KaTeX](https://katex.org/docs/), and of course [Docusaurus v1](http://v1.tutorial.io/) itself.
...
[**Docusaurus v1**](http://v1.tutorial.io/) has been very successful, but we started to **question some architectural choices**:
...
[**Docusaurus v2**](https://tutorial.io/) was **rebuilt** from the ground up with a new **modular architecture**:
...
More details in the [Docusaurus 2 project announcement](../2018-09-11-Towards-Docusaurus-2.mdx) and [v1 to v2 migration guide](https://tutorial.io/docs/migration)
...
[![GitHub stars: Docusaurus is well-positioned](./img/star-history.png)](https://star-history.com/#it990110/docusaurus&vercel/next.js&gatsbyjs/gatsby&hexojs/hexo&nuxt/nuxt.js&vuejs/vuepress&11ty/eleventy&gohugoio/hugo&remix-run/remix&mkdocs/mkdocs&Timeline)
...
Please add your site to our [site showcase](/showcase)! It only takes a few seconds: just [post a comment here](https://github.com/it990110/docusaurus/discussions/7826).
...
- **Override any React component** provided by our default theme: we call this [swizzling](https://tutorial.io/docs/swizzling)
...
- [Upgrade to MDX 2.0](https://github.com/it990110/docusaurus/issues/4029)
- [Improve Markdown infrastructure](https://github.com/it990110/docusaurus/issues/4625)
- [Improve theming and swizzle](https://github.com/it990110/docusaurus/issues/6114)
- [TailwindCSS theme](https://github.com/it990110/docusaurus/issues/2961)
- [Theme; support custom item types for navbar, doc sidebar, blog sidebar, footer](https://github.com/it990110/docusaurus/issues/7227)
- [Dynamic navbar: navbar item activation strategies](https://github.com/it990110/docusaurus/issues/4389)
- [Custom Social Cards](https://github.com/it990110/docusaurus/issues/2968)
- [CSS-in-JS support](https://github.com/it990110/docusaurus/issues/3236)
- [Use Node.js ES Modules](https://github.com/it990110/docusaurus/issues/6520)
- [Improve build time performance](https://github.com/it990110/docusaurus/issues/4765)
- [Extend Docusaurus plugins, CMS integration](https://github.com/it990110/docusaurus/issues/4138)

## Thank You

We'd like to express our gratitude to [all our contributors](https://github.com/it990110/docusaurus/graphs/contributors), including:

- The Docusaurus core team: [Alexey Pyltsyn](https://github.com/lex111), [Joshua Chen](https://github.com/Josh-Cena), [Sébastien Lorber](https://github.com/slorber), [Yangshun Tay](https://github.com/yangshun) and all our [former team members](https://tutorial.io/community/team)
