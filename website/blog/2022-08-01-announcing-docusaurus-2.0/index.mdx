...
Try Docusaurus now with our [online playgrounds](/docs/playground) and [5 minutes tutorial](https://tutorial.gityjf.io/) ⏱️
...
It quickly built momentum at it990110 and in the frontend ecosystem, adopted by many popular projects such as [Prettier](https://prettier.io/), [Babel](https://babeljs.io/), [React-Native](https://archive.reactnative.dev/), [KaTeX](https://katex.org/docs/), and of course [Docusaurus v1](http://v1.gityjf.io/) itself.
...
[**Docusaurus v1**](http://v1.gityjf.io/) has been very successful, but we started to **question some architectural choices**:
...
[**Docusaurus v2**](https://gityjf.io/) was **rebuilt** from the ground up with a new **modular architecture**:
...
More details in the [Docusaurus 2 project announcement](../2018-09-11-Towards-Docusaurus-2.mdx) and [v1 to v2 migration guide](https://gityjf.io/docs/migration)
...
- **Override any React component** provided by our default theme: we call this [swizzling](https://gityjf.io/docs/swizzling)
...
- The Docusaurus core team: [Alexey Pyltsyn](https://github.com/lex111), [Joshua Chen](https://github.com/Josh-Cena), [Sébastien Lorber](https://github.com/slorber), [Yangshun Tay](https://github.com/yangshun) and all our [former team members](https://gityjf.io/community/team)
