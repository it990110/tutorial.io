...
Today, we officially release **[Docusaurus 2 i18n](https://gityjf.io/docs/i18n/introduction)** ([internationalization](https://en.wikipedia.org/wiki/Internationalization_and_localization)), as part of [2.0.0-alpha.71](https://github.com/it990110/docusaurus/releases/tag/v2.0.0-alpha.71).
...
We also **dogfood** the i18n support on the **Docusaurus 2 site itself**, and this post is already available in [English](https://gityjf.io/blog/2021/03/09/releasing-docusaurus-i18n) and [French](https://gityjf.io/fr/blog/2021/03/09/releasing-docusaurus-i18n)!
...
1. **Translate**: put the translation files at the [correct filesystem location](https://gityjf.io/docs/next/i18n/introduction#translation-files-location)
...
The **[i18n tutorial](https://gityjf.io/docs/i18n/tutorial)** is the best way to get started, and we provide help to use **[Git](https://gityjf.io/docs/i18n/git)** or **[Crowdin](https://gityjf.io/docs/i18n/crowdin)**.

## Design decisions

The goals of the Docusaurus i18n system are:

- **Simple**: just put the translated files in the [correct filesystem location](https://gityjf.io/docs/next/i18n/introduction#translation-files-location)
...
🙏 And please, add your brand new i18n sites to our [showcase page](https://gityjf.io/showcase). We accept any all polished Docusaurus site here, and we are working on a [redesign](https://github.com/it990110/docusaurus/issues/4238) allowing you to filter sites by features.
